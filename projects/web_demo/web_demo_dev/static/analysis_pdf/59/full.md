...
<div style="background-color:#F4433633;" meta-id="4-20-0-0">
...
</div meta-id="4-20-0-0">

Solution. 

<div style="background-color:#4CAF5033;" meta-id="28-54-10-37">

The associated eigenvalue problem ${y}^{\prime \prime } + {\lambda y} = 0, y\left( 0\right)  = y\left( \pi \right)  = 0$ has eigenvalues $\lambda  = {n}^{2}$ and eigenfunctions $\sin {nx}, n = 1,2,\ldots$ . So we look for a solution in the form
...
<div style="background-color:#2196F333;" meta-id="54-56-0-0">

$$
u\left( {x, t}\right)  = {e}^{-t}\sin x + {e}^{-{8t}}\sin {2x},
$$

</div meta-id="54-56-0-0">

which can be checked by substitution.

</div meta-id="28-54-10-37">





<div style="background-color:#F4433633;" meta-id="70-76-0-0">
...
</div meta-id="70-76-0-0">



<div style="background-color:#4CAF5033;" meta-id="84-110-0-0">
...
<div style="background-color:#2196F333;" meta-id="118-120-0-0">

$$
F\left\lbrack  {\cos x/\left( {{x}^{2} + 4}\right) }\right\rbrack   = \frac{\pi }{4}\left( {{e}^{-2\left| {s - 1}\right| } + {e}^{-2\left| {s + 1}\right| }}\right) .
$$

</div meta-id="118-120-0-0">

</div meta-id="84-110-0-0">



<div style="background-color:#F4433633;" meta-id="128-152-0-0">
...
<div style="background-color:#4CAF5033;" meta-id="162-216-0-0">



<div style="background-color:#2196F333;" meta-id="166-0-22">

Answer: D, B, A, E, C.

</div meta-id="166-0-22">
...
</div meta-id="162-216-0-0">



<div style="background-color:#F4433633;" meta-id="232-248-0-0">
...
</div meta-id="232-248-0-0">



<div style="background-color:#4CAF5033;" meta-id="256-302-0-0">
...
<div style="background-color:#2196F333;" meta-id="300-302-0-0">
...
</div meta-id="316-336-0-0">



<div style="background-color:#4CAF5033;" meta-id="344-384-0-0">

Solution. a) Plugging $u\left( {x, t}\right)  = X\left( x\right) T\left( t\right)$ , we obtain



<div style="background-color:#2196F333;" meta-id="350-352-0-0">

$$
\frac{{T}^{\prime \prime }}{T} + 2\frac{{T}^{\prime }}{T} + 1 = \frac{{X}^{\prime \prime }}{X}
$$

</div meta-id="350-352-0-0">
...
<div style="background-color:#2196F333;" meta-id="368-3-89">

$\lambda  =  - {\left( \pi n\right) }^{2},\;n = 1,2,\ldots ;{X}_{n} = \cos {\pi nx}$ .

</div meta-id="368-3-89">
...
<div style="background-color:#2196F333;" meta-id="406-408-0-0">
...
</div meta-id="406-408-0-0">

d) 

<div style="background-color:#2196F333;" meta-id="418-3-129">

As $t \rightarrow  \infty$ it tends to zero, because of the exponential factor, while oscillating with frequencies ${\pi n}$ .

</div meta-id="418-3-129">

</div meta-id="344-384-0-0">



<div style="background-color:#F4433633;" meta-id="418-434-0-0">
...
</div meta-id="418-434-0-0">



<div style="background-color:#4CAF5033;" meta-id="442-454-0-0">

Solution.

a) 

<div style="background-color:#2196F333;" meta-id="448-3-8">

False

</div meta-id="448-3-8">

. Example: $f\left( x\right)  = 1/\left( {\left( {1 + {x}^{2}}\right) \sqrt{x}}\right)$ in in ${L}^{1}$ but not in ${L}^{2}$ .

b) 

<div style="background-color:#2196F333;" meta-id="458-3-8">

False

</div meta-id="458-3-8">

. Example: $f\left( x\right)  = x/\left( {1 + {x}^{2}}\right)$ is in ${L}^{2}$ but not in ${L}^{1}$ .

c) 

<div style="background-color:#2196F333;" meta-id="468-3-7">

True

</div meta-id="468-3-7">

. If $\left| {f\left( x\right) }\right|  \leq  M$ then $\int {\left| f\left( x\right) \right| }^{2}{dx} \leq  M\int \left| {f\left( x\right) }\right| {dx}$ .

d) 

<div style="background-color:#2196F333;" meta-id="478-3-8">

False

</div meta-id="478-3-8">

. Same example as in b).

e) 

<div style="background-color:#2196F333;" meta-id="488-3-7">

True

</div meta-id="488-3-7">

. If $f$ has period $T$ and is not the zero function, then ${\int }_{0}^{T}{\left| f\left( x\right) \right| }^{2}\left( x\right) {dx} >$ 0, thus ${\int }_{-\infty }^{\infty }{\left| f\left( x\right) \right| }^{2}{dx} =  + \infty$ .



</div meta-id="442-454-0-0">



<div style="background-color:#F4433633;" meta-id="502-522-0-0">
...
</div meta-id="502-522-0-0">



<div style="background-color:#4CAF5033;" meta-id="530-544-0-776">

Solution. 

<div style="background-color:#2196F333;" meta-id="534-10-48">

a), b), e) are false; c), d) are true.

</div meta-id="534-10-48">
