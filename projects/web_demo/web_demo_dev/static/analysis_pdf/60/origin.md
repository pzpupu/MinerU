...
(The function $w\left( {t - u}\right)$ is called the Green’s function for the linear operator ${D}^{2} + {aD} + b$ .) M.I.T. 18.03 Ordinary Differential Equations 18.03 Notes and Exercises
