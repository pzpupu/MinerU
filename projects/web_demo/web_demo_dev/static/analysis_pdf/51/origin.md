...
A. 2 units B. 3 units A. $\frac{9x}{{y}^{7}}$ C. 4 units B. $\frac{9{y}^{7}}{x}$ D. 5 units E. 6 units C. $\frac{{x}^{2}}{9{y}^{3}}$
...
E. 4.3 37. Toni is a repair technician for a phone company. Each week, she receives a batch of phones that need repairs. The number of phones that she has left to fix at the end of each day can be estimated with the equation $P = {100} - {25d}$ where $P$ is the number of phones left and $d$ is the number of days she has worked that week. Which of the following is correct about this equation?
