...
<div style="background-color:#F4433633;" meta-id="18-9-73">

Find the general solution of ${y}^{\prime \prime } - {xy} = 0$ .
...
<div style="background-color:#4CAF5033;" meta-id="30-126-0-515">
...
<div style="background-color:#2196F333;" meta-id="122-128-0-0">
...
<div style="background-color:#F4433633;" meta-id="274-9-185">

Solve $2{x}^{2}{y}^{\prime \prime } + {3x}{y}^{\prime } - y = 0$ for $0 \leq  x \leq  1$ with two-point boundary condition $y\left( 0\right)  = 0$ and $y\left( 1\right)  = 1$ .

</div meta-id="274-9-185">

<div style="background-color:#4CAF5033;" meta-id="284-310-0-448">
...
<div style="background-color:#2196F333;" meta-id="314-316-0-0">

$$
y\left( x\right)  = \sqrt{x}.
$$

</div meta-id="314-316-0-0">
...
</div meta-id="284-310-0-448">



Example: 

<div style="background-color:#F4433633;" meta-id="320-9-174">

Solve ${x}^{2}{y}^{\prime \prime } + x{y}^{\prime } + {\pi }^{2}y = 0$ with two-point boundary condition $y\left( 1\right)  = 1$ and $y\left( \sqrt{e}\right)  = 1$ .

</div meta-id="320-9-174">





<div style="background-color:#4CAF5033;" meta-id="330-346-0-147">
...
<div style="background-color:#2196F333;" meta-id="346-348-0-0">

$$
y\left( x\right)  = A\cos \left( {\pi \ln x}\right)  + B\sin \left( {\pi \ln x}\right) .
$$
</div meta-id="346-348-0-0">

The first boundary condition $y\left( 1\right)  = 1$ yields $A = 1$ . The second boundary condition $y\left( \sqrt{e}\right)  = 1$ yields $B = 1$ .

</div meta-id="330-346-0-147">



Example:

<div style="background-color:#F4433633;" meta-id="361-8-163">

 Solve ${x}^{2}{y}^{\prime \prime } + {5x}{y}^{\prime } + {4y} = 0$ with two-point boundary condition $y\left( 1\right)  = 0$ and $y\left( e\right)  = 1$ .

</div meta-id="361-8-163">





<div style="background-color:#4CAF5033;" meta-id="371-395-0-0">
...
<div style="background-color:#2196F333;" meta-id="397-403-0-0">

$$
y\left( x\right)  = \frac{{e}^{2}\ln x}{{x}^{2}}.
$$

</div meta-id="371-395-0-0">
</div meta-id="397-403-0-0">
